...
from apps.cart.views import get_session_id
...
def product_detail(request, category_slug, product_slug):
    ...
    in_cart = CartItem.objects.filter(cart__session_id=get_session_id(request), product=product).exists()
...
class ProductDetailView(DetailView):
    ...
    def get_context_data(self, **kwargs):
        ...
        context["in_cart"] = CartItem.objects.filter(
            cart__session_id=get_session_id(self.request), product=product
        ).exists()
